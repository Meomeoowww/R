...
#le nom du domaine et le sqlquery!! Ensuite veiller a installer RTools et les autres librairies n?ccessaires.
...
#formattage des variables d'int?ret en num?rique
